...
public class Logic {
    ...
    public static int winnerName = 0;
    ...
    public static void go() {
        ...
        if (checkWinLines(DOT_X)) {
            ...
            winnerName = 1;
            VictoryWindow victoryHuman = new VictoryWindow();
            return;
        }
        ...
        if (isFull()) {
            ...
            winnerName = 3;
            VictoryWindow victoryNo = new VictoryWindow();
            return;
        }
        ...
        if (checkWinLines(DOT_O)) {
            ...
            winnerName = 2;
            VictoryWindow victoryAi = new VictoryWindow();
            return;
        }
